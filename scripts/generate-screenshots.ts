  ...
  const dummyItems: MiasmaItem[] = [
    {
      ...
      span: { startLine: 42, endLine: 42, lines: ['console.log("DEBUG token:", token);'] },
    ...
    },
    {
      ...
      span: { startLine: 15, endLine: 15, lines: ['// @ts-ignore'] },
    ...
    },
    {
      ...
      span: { startLine: 8, endLine: 8, lines: ['const p = "/home/developer/secret.pem";'] },
    ...
    },
    {
      ...
      category: 'TOMBSTONE',
      ruleId: 'tombstone/python',
      span: { startLine: 94, endLine: 94, lines: ['# commented out block'] },
